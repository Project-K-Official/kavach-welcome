...
#######################################################################################################################################
    ...
    def setupUi(self, WelcomeScreen):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/usr/share/kavach-welcome/img/kavach-welcome.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Logo.setText("")
        self.Logo.setPixmap(QtGui.QPixmap("/usr/share/kavach-welcome/img/logo.png"))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("/usr/share/kavach-welcome/img/news.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("/usr/share/kavach-welcome/img/forums.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("/usr/share/kavach-welcome/img/helpus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/usr/share/kavach-welcome/img/wiki.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("/usr/share/kavach-welcome/img/chat.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/usr/share/kavach-welcome/img/donate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/usr/share/kavach-welcome/img/install.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/usr/share/kkavach-welcome/img/install.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, WelcomeScreen):
        ...
        WelcomeScreen.setWindowTitle(_translate("WelcomeScreen", "Welcome To Kavach OS"))
        ...
        self.infoLabel.setText(_translate("WelcomeScreen", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Welcome to Kavach OS. The links below will help you get started. Enjoy and feel free to send us your feedback.</span></p></body></html>"))
